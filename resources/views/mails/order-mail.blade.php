				...
				<div class="invoice-box">
					<table cellpadding="0" cellspacing="0">
						<tr class="top">
							<td colspan="2">
								<table>
									<tr>
										<td class="title">
											<img src="https://mykomodo.kabtour.com/uploads/0000/1/2023/03/12/192x192.PNG" style="margin: auto;width: 100%; max-width: 180px" />
										</td>

										<td style="text-align: right!important;">
											Invoice: ITD-{{App\Models\Payment::where('code',$order->code_booking)->first()->bill_no}}<br />
						...
						<tr style="    border: 2px solid #eee;" class="details">
							...
							<td>Di Antarkan ke <br />{{$order->line1}}</td>
							@else
							<td>Di Ambil di toko</td>
							@endif
